# Fluxo Completo da Jornada do Agentforce Service – Belle VetCare CRM
...
### 1. Cadastro
O Agent coleta os dados do tutor e do pet em uma sequência lógica.
...
Usuário → Agent → Dialog → Decision → Salesforce Flow → Objetos (Tutor, Pet, Agendamento) → Resposta ao usuário.
